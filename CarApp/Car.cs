...
namespace CarsApp
{
    ...
    public class Car
    {
        ...
        public override bool Equals(object otherCarObj)
        {
            var otherCar = (Car)otherCarObj;
            return this.DrivingMode == otherCar.DrivingMode && this.Velocity == otherCar.Velocity && this.Type == otherCar.Type;
        }
